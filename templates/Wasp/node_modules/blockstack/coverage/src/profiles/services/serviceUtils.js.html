...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/services/serviceUtils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/profiles/services</a> serviceUtils.js
    </h1>
    <div class='clearfix'>
...
export function containsValidProofStatement(searchText: string, name: ?string = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span> {

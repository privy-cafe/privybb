...
<html lang="en">
<head>
    <title>Code coverage report for src/keys.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> keys.js
    </h1>
    <div class='clearfix'>
...
export function getEntropy(numberOfBytes: number) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!numberOfBytes) {

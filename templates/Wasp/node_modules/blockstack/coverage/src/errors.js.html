...
<span class="fstat-no" title="function not covered" >  co</span>nstructor(parameter: string, message: string = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
...
<span class="fstat-no" title="function not covered" >  co</span>nstructor(message: string) {

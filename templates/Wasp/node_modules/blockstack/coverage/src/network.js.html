  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>298/366</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>121/145</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.27% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>295/363</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="fstat-no" title="function not covered" >  br</span>oadcastTransaction(transaction: string) : Promise&lt;Object&gt; {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>tBlockHeight() : Promise&lt;Number&gt; {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error('Not implemented, getBlockHeight()'))</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>tTransactionInfo(txid: string) : Promise&lt;{block_height: Number}&gt; {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>tNetworkedUTXOs(address: string) : Promise&lt;Array&lt;UTXO&gt;&gt; {
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Failed to get price for ${namespaceID}`)</span>
        ...
        if (namespacePrice.units === 'BTC') {
          // must be at least dust-minimum
          const dustMin = bigi.fromByteArrayUnsigned(String(this.DUST_MINIMUM))
          <span class="missing-if-branch" title="if path not taken" >I</span>if (result.amount.compareTo(dustMin) &lt; 0) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  co</span>untDustOutputs() {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>tTransactionInfo(txHash: string) : Promise&lt;{block_height: Number}&gt; {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>tFeeRate() : Promise&lt;number&gt; {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  br</span>oadcastTransaction(transaction: string) {
...
<span class="cstat-no" title="statement not covered" >    return fetch(this.bitcoindUrl, {</span>
      ...
      .then(<span class="fstat-no" title="function not covered" >re</span>sp =&gt; <span class="cstat-no" title="statement not covered" >resp.json())</span>
      .then(<span class="fstat-no" title="function not covered" >re</span>spObj =&gt; <span class="cstat-no" title="statement not covered" >respObj.result)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  ge</span>tBlockHeight() {
    const jsonRPC = <span class="cstat-no" title="statement not covered" >{</span>
      jsonrpc: '1.0',
...
<span class="cstat-no" title="statement not covered" >    return fetch(this.bitcoindUrl, {</span>
      ...
      .then(<span class="fstat-no" title="function not covered" >re</span>sp =&gt; <span class="cstat-no" title="statement not covered" >resp.json())</span>
      .then(<span class="fstat-no" title="function not covered" >re</span>spObj =&gt; <span class="cstat-no" title="statement not covered" >respObj.result)</span>
      .then(<span class="fstat-no" title="function not covered" >tx</span>Info =&gt; <span class="cstat-no" title="statement not covered" >txInfo.blockhash)</span>
...
<span class="fstat-no" title="function not covered" >        x </span>=&gt; <span class="cstat-no" title="statement not covered" >Object({</span>
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Could not lookup transaction info for '${txHash}'. Server error.`)</span>
      ...
      .then(<span class="fstat-no" title="function not covered" >re</span>spObj =&gt; (<span class="cstat-no" title="statement not covered" >{ block_height: respObj.block_height })</span>)
  }
&nbsp;
  broadcastTransaction(transaction: string) {

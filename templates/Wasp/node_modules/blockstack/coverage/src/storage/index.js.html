...
<html lang="en">
<head>
    <title>Code coverage report for src/storage/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/storage</a> index.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.93% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>164/216</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>162/214</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L749'></a><a href='#L749'>749</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
export function <span class="fstat-no" title="function not covered" >encryptContent(</span>content: string | Buffer, options?: {publicKey?: string}) {
<span class="cstat-no" title="statement not covered" >  console.warn('DEPRECATION WARNING: The static encryptContent() function will be deprecated in '</span>
...
<span class="cstat-no" title="statement not covered" >  return userSession.encryptContent(content, options)</span>
}
&nbsp;
/**
 ...
 */
export function <span class="fstat-no" title="function not covered" >decryptContent(</span>content: string, options?: {privateKey?: ?string}) {
<span class="cstat-no" title="statement not covered" >  console.warn('DEPRECATION WARNING: The static decryptContent() function will be deprecated in '</span>
    + 'the next major release of blockstack.js. Create an instance of UserSession and call the '
    + 'instance method decryptContent().')
  const userSession = <span class="cstat-no" title="statement not covered" >new UserSession()</span>
<span class="cstat-no" title="statement not covered" >  return userSession.decryptContent(content, options)</span>
}
&nbsp;
/**
 ...
 */
export function <span class="fstat-no" title="function not covered" >getFile(</span>path: string, options?: {
    decrypt?: boolean,
    verify?: boolean,
    username?: string,
    app?: string,
...
<span class="cstat-no" title="statement not covered" >  console.warn('DEPRECATION WARNING: The static getFile() function will be deprecated in '</span>
    + 'the next major release of blockstack.js. Create an instance of UserSession and call the '
    + 'instance method getFile().')
  const userSession = <span class="cstat-no" title="statement not covered" >new UserSession()</span>
<span class="cstat-no" title="statement not covered" >  return userSession.getFile(path, options)</span>
}
&nbsp;
/**
 ...
 * if it failed
 */
export function <span class="fstat-no" title="function not covered" >putFile(</span>path: string, content: string | Buffer, options?: {
  encrypt?: boolean | string,
  sign?: boolean,
  contentType?: string
  }) {
<span class="cstat-no" title="statement not covered" >  console.warn('DEPRECATION WARNING: The static putFile() function will be deprecated in '</span>
    + 'the next major release of blockstack.js. Create an instance of UserSession and call the '
    + 'instance method putFile().')
  const userSession = <span class="cstat-no" title="statement not covered" >new UserSession()</span>
<span class="cstat-no" title="statement not covered" >  return userSession.putFile(path, content, options)</span>
}
&nbsp;
/**
 ...
 */
export function <span class="fstat-no" title="function not covered" >listFiles(</span>callback: (name: string) =&gt; boolean) : Promise&lt;number&gt; {
<span class="cstat-no" title="statement not covered" >  console.warn('DEPRECATION WARNING: The static listFiles() function will be deprecated in '</span>
    + 'the next major release of blockstack.js. Create an instance of UserSession and call the '
    + 'instance method listFiles().')
  const userSession = <span class="cstat-no" title="statement not covered" >new UserSession()</span>
<span class="cstat-no" title="statement not covered" >  return userSession.listFiles(callback)</span>
}
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >        return null</span>
    ...
    .then((bucketUrl) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (bucketUrl) {
 ...
 */
export function <span class="fstat-no" title="function not covered" >getFileUrl(</span>path: string, options?: {
    username?: string,
    app?: string,
    zoneFileLookupURL?: ?string
  }): Promise&lt;string&gt; {
<span class="cstat-no" title="statement not covered" >  console.warn('DEPRECATION WARNING: The static getFileUrl() function will be deprecated in '</span>
    + 'the next major release of blockstack.js. Create an instance of UserSession and call the '
    + 'instance method getFileUrl().')
  const userSession = <span class="cstat-no" title="statement not covered" >new UserSession()</span>
<span class="cstat-no" title="statement not covered" >  return getFileUrlImpl(userSession, path, options)</span>
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          setLocalGaiaHubConnection(caller)</span>
            .then(<span class="fstat-no" title="function not covered" >fr</span>eshHubConfig =&gt; <span class="cstat-no" title="statement not covered" >Promise.all([</span>
...
&nbsp;
  return fetch(`${hubConfig.server}/list-files/${hubConfig.address}`, fetchOptions)
    .then((response) =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (httpStatus &gt;= 400) {

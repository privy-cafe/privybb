...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/ec.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> ec.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  if (hexOut.length === 64) {
    return hexOut
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (hexOut.length &lt; 64) {

...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/wallet.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> wallet.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    const hmacDigestHash = crypto.createHash('sha256')
      ...
      .toString('hex')
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hmacSigHash !== hmacDigestHash) {
      // not authentic
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!bip39.validateMnemonic(mnemonic)) {
...
export function decryptMnemonic(data: (string | Buffer), password: string) {
  const dataBuffer = Buffer.isBuffer(data) ? <span class="branch-0 cbranch-no" title="branch not covered" >data </span>: Buffer.from((data: any), 'hex')

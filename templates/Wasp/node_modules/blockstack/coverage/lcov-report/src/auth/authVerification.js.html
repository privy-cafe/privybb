...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/authVerification.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> authVerification.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>62/79</span>
      </div>
    </div>
    <p class="quiet">
...
export function verifyAuthResponse(token: string, nameLookupURL: string) {
  return Promise.all([
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (values.every(Boolean)) {
      return true
    } else {
<span class="cstat-no" title="statement not covered" >      return false</span>
    }

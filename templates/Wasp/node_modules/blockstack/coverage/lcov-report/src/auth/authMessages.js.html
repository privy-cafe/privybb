...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/authMessages.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> authMessages.js
    </h1>
    <div class='clearfix'>
...
export function makeAuthRequestImpl(transitPrivateKey: string,
                                    ...
                                    manifestURI: string,
                                    scopes: Array&lt;string&gt;,
                                    appDomain: string = <span class="branch-0 cbranch-no" title="branch not covered" >window.location.origin,</span>
                                    expiresAt: number,
                                    extraParams: Object = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span>: string {
  /* Create the payload */

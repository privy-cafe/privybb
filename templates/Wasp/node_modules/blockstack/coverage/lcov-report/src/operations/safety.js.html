...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/safety.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/operations</a> safety.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >  return config.network.getAccountStatus(address, tokenType)</span>
    .then(<span class="fstat-no" title="function not covered" >ac</span>countStatus =&gt; <span class="cstat-no" title="statement not covered" >accountStatus.transfer_send_block_id &gt;= blockHeight)</span>
}
&nbsp;
export const safety = {

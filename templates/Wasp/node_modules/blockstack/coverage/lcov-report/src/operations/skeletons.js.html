...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/skeletons.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/operations</a> skeletons.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>225/251</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cstat-no" title="statement not covered" >    return { units: 'BTC', amount: BigInteger.fromByteArrayUnsigned(String(amount)) }</span>
  } else {
...
<span class="cstat-no" title="statement not covered" >    btcBurnAmount = parseInt(burnAmount.amount.toHex(), 16)</span>
  }
&nbsp;
  const opReturnBuffer = Buffer.alloc(opReturnBufferLen)
  opReturnBuffer.write(opEncode('*'), 0, 3, 'ascii')

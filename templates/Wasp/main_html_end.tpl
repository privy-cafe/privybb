...
[special:stats]
<br>
<p>[case:[special:lang]| Board load time|Време за обработка на страницата|Время обработки страницы|Page chargée en|Seite verarbeitet in]: [special:timestamp] ms</p>
</div>

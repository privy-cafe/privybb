...
[case:[special:lang]|
  ...
  [equ:helpRegister=
    <p>Even if Privy is entirely encrypted and use full disk encryption, you should use a unique password and email.</p>
    <p>Humans are horrible when it come to remembering random strings, but pretty good in keeping small sheets of paper.</p>
    <p>Use this memo to unlock a wonderful password manager.</p>
    <p>... Even using multiple password manager is appropriated !</p>
  ]
|
  [equ:btnThreads=Теми]

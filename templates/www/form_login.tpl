...
[case:[special:lang]|
  ...
  [equ:helpLogin=
    [case:[email_flag]||<p>Ay forgot ya password matey ? <b><a href="/!resetpassword">click here</a></b>. Be careful, you have limited reset attempts.</p>]
    [case:[special:canregister]||<p>If you don't have an account,<b><a href="/!register">Claim One !</a></b>.</p>]
    <p></p>
    ...
    <p>If the "Persistent login" checkbox is not checked (default), PrivyERA, Privy , Privy Edge and other services uses "session cookies" that are automatically removed when you close your browser.</p>
    <p>When you logout from the forum, all cookies are removed. We do not hold any data</p>
  ]
|
  [equ:btnThreads=Теми]
